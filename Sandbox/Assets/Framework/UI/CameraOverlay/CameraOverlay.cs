...
public class CameraOverlay : MonoBehaviour
{
    ...
    {
        var go = new GameObject("[CameraOverlay]");
        go.AddComponent<CameraOverlay>();
    ...
    private void Start()
    {
        ...
        var vta = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Framework/UI/CameraOverlay/CameraOverlay.uxml");
