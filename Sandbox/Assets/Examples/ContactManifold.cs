...
public sealed class ContactManifold : SandboxExampleBehaviour
{
    ...
    private void HandleInput()
    {
        ...
        var worldPosition = (Vector2)CameraManipulator.Camera.ScreenToWorldPoint(currentMouse.position.ReadValue());
    ...
    {
        // No persistent physics bodies — everything is drawn each frame in Update.
    }
}
