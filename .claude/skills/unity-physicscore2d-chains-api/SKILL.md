...
| `owner` | The owner object associated with this chain, or NULL if no owner has been specified. This is a convenience property that returns the same value as PhysicsChain.GetOwner. |
