...
[Serializable]
internal class TestBodyShadowProvider : TestShadowProviderBase
{
    ...
    {
        // Fetch the test body shadow.
        var testBody = sourceComponent as TestBody;
        if (testBody != null)
        {
            // Yes, so fetch shapes on the body.
            var physicsBody = testBody.body;
