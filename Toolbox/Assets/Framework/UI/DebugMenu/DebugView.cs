...
public class DebugView : MonoBehaviour, IFoldable
{
    ...
    public void SetRolledUp(bool rolledUp)
    {
        ...
        var caret = rolledUp ? "▶" : "▼";
        m_RollupToggle.text = $"{ToolboxUtility.HighlightColor}{caret}{ToolboxUtility.EndHighlightColor}<size=50%> </size>Debug";
    }
    ...
    private static void SetSectionCollapsed(Button header, string title, VisualElement region, bool collapsed)
    {
        ...
        var caret = collapsed ? "▶" : "▼";
        header.text = $"{ToolboxUtility.HighlightColor}{caret}{ToolboxUtility.EndHighlightColor}<size=50%> </size>{title}";
    }
    ...
    private void Update()
    {
        ...
        const string color = ToolboxUtility.HighlightColor;
        const string endColor = ToolboxUtility.EndHighlightColor;
    ...
    private void UpdateFPS()
    {
        ...
        if (m_BarFPS != null && deltaTime > 0f)
        {
            ...
            m_BarFPS.value = fps;
            m_BarFPS.title = $"{ToolboxUtility.HighlightColor}{fps:F1}{ToolboxUtility.EndHighlightColor} fps ({ToolboxUtility.HighlightColor}{1000f / fps:F1}{ToolboxUtility.EndHighlightColor} ms)";
        }
    }
