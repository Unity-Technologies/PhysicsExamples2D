...
public static class SpawnFactory
{
    ...
    {
        public static NativeList<PhysicsBody> SpawnCar(PhysicsWorld world, Vector2 position, float carScale, float suspensionFrequency, float suspensionDamping, float maxMotorTorque, float gravityScale, out PhysicsWheelJoint rearWheelJoint, out PhysicsWheelJoint frontWheelJoint, Allocator allocator = Allocator.Temp)
        {
            NativeList<PhysicsBody> bodies = new(allocator);
