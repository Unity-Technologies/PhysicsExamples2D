...
{
    [AddComponentMenu("Physics 2D/CoreExamples/Test Distance Joint", 40)]
    [Icon(IconUtility.IconPath + "TestDistanceJoint.png")]
    [MovedFrom(autoUpdateAPI: APIUpdates.AutoUpdateAPI, sourceNamespace: APIUpdates.RuntimeSourceNamespace, "SceneDistanceJoint")]
