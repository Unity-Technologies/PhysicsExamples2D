...
{
    [EditorTool("Edit Test Chain", typeof(TestChain))]
    internal sealed partial class TestChainTool : EditorTool, IGeometryToolSettings
    {
        public override void OnActivated()
        {
            ...
            {
                if (toolTarget is TestChain testChainShape)
                {
                    if (testChainShape.isActiveAndEnabled)
                        m_GeometryTools.Add(new ChainTestChainGeometryEditorTool(testChainShape, this));
                }
            }
        }
        ...
        /// Chain Geometry Tool.
        /// </summary>
        private sealed class ChainTestChainGeometryEditorTool : TestChainGeometryEditorTool
        {
            public ChainTestChainGeometryEditorTool(TestChain testChain, IGeometryToolSettings geometryToolSettings) : base(testChain, geometryToolSettings)
            {
            }
