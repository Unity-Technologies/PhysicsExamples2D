...
namespace Unity.U2D.Physics.Editor.Extras
{
    ...
    internal class TestGeometryToolOverlay : Overlay, ITransientOverlay
    {
        private const string OverlayId = "Scene View/TestShape Tool";
        private const string DefaultName = "TestShapeTool";
        ...
        public TestGeometryToolOverlay()
        {
        }

        public TestGeometryToolOverlay(IGeometryToolSettings geometryToolSettings)
        {
