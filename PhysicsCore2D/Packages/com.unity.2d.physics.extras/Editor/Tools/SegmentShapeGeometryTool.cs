...
namespace Unity.U2D.Physics.Editor.Extras
{
    internal sealed partial class TestShapeEditorTool
    {
        ...
        /// </summary>
        private sealed class SegmentShapeGeometryTool : TestShapeGeometryTool
        {
            public SegmentShapeGeometryTool(TestShape testShape, IGeometryToolSettings geometryToolSettings) : base(testShape, geometryToolSettings)
            {
            }
            ...
            public override void OnToolGUI(EditorWindow window)
            {
                ...
                // Segment Mid.
                var centerOriginMid = ToBodyPosition3D((geometry.point1 + geometry.point2) * 0.5f);
                ...
                // Point #1.
                var pointOrigin1 = ToBodyPosition3D(geometry.point1);
                ...
                // Point2 #2.
                var pointOrigin2 = ToBodyPosition3D(geometry.point2);
