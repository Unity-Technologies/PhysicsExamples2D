...
public sealed class GeometryIslands : SandboxExampleBehaviour, PhysicsCallbacks.IContactCallback
{
    ...
    protected override void SetupOptions()
    {
        ...
        // Fragment Colors.
        AddEnum("Fragment Colors", m_FragmentColors, v => m_FragmentColors = v, rebuild: false);

        // Fragment Explode.
        AddToggle("Fragment Explode", m_FragmentExplode, v => m_FragmentExplode = v, rebuild: false);
    }
