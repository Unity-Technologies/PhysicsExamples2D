...
// Starter template for a new Sandbox example. Copy this whole "Example" folder, rename the
// folder + the two files (Example.cs/.unity) to your example's name, rename this class to match
// the .cs file, then update the [ExampleScene] category/description below. Finally run
// Tools > 2D > Physics > Rebuild Sandbox Registry to register it. See AUTHORING_EXAMPLES.md for the
// full recipe and the gotchas.
