...
* A [PhysicsWorld](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsWorld.html) uses a [PhysicsWorldDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsWorldDefinition.html)
* A [PhysicsBody](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody.html) uses a [PhysicsBodyDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBodyDefinition.html)
* A [PhysicsShape](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsShape.html) uses a [PhysicsShapeDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsShape.html)
* etc.
...
* [PhysicsWorldDefinition.defaultDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsWorldDefinition-defaultDefinition.html)
* [PhysicsBodyDefinition.defaultDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBodyDefinition-defaultDefinition.html)
* [PhysicsShapeDefinition.defaultDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsShape.html)
* etc.
...
**Note:** The values in a default definition are not fixed, you can customize these defaults to suit your project's needs. For more information, see [Project Settings](PhysicsCoreSettings2D.md).
...
For example:
- [PhysicsBodyDefinition.type](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBodyDefinition-type.html) and [PhysicsBody.type](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody-type.html)
- [PhysicsBodyDefinition.linearVelocity](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBodyDefinition-linearVelocity.html) and [PhysicsBody.linearVelocity](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody-linearVelocity.html)
- [PhysicsShapeDefinition.isTrigger](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsShapeDefinition-isTrigger.html) and [PhysicsShape.isTrigger](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsShape-isTrigger.html)
- etc.
