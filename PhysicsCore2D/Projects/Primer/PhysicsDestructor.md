...
The [PhysicsDestructor](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsDestructor.html) can break down (decompose) input geometries using two methods: [Fragment](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsDestructor.Fragment.html) and [Slice](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsDestructor.Slice.html).

The `PhysicsDestructor` always operates on [PolygonGeometry](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PolygonGeometry.html).
