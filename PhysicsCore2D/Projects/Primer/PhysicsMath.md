...
- [GetTranslationAxes](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.GetTranslationAxes.html)
- [GetTranslationIgnoredAxis](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.GetTranslationIgnoredAxis.html)
- [GetTranslationIgnoredAxes](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.GetTranslationIgnoredAxes.html)
- [GetRotationAxes](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.GetRotationAxes.html)
- [GetRotationIgnoredAxes](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.GetRotationIgnoredAxes.html)

Finally, simpler helpers like [Swizzle](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.Swizzle.html) and [ToPhysicsTransform](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.ToPhysicsTransform.html) let you swap axes and convert a Unity `Transform` directly into a `PhysicsTransform`.

## Utility

Additional utility functions include [ToDegrees](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.ToDegrees.html), [ToRadians](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.ToRadians.html), [MaxAbsComponent](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.MaxAbsComponent.html), [MinAbsComponent](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.MinAbsComponent.html), [AngularVelocityToQuaternion](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.AngularVelocityToQuaternion.html), and [SpringDamper](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.SpringDamper.html).

## Determinism

Several features are provided purely to improve determinism, including [PI](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.PI.html), [TAU](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.TAU.html), [Atan2](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.Atan2.html), and [CosSin](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsMath.CosSin.html).
