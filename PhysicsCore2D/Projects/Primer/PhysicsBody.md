...
A `PhysicsBody` uses its own [PhysicsBodyDefinition](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBodyDefinition.html) to specify how the body should be created.
...
- **Allowing Sleep**: [PhysicsBody.sleepingAllowed](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody-sleepingAllowed.html)
- **Sleeping Threshold**: [PhysicsBody.sleepingThreshold](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody-sleepThreshold.html)
- **Monitor/Change Sleep State**: [PhysicsBody.awake](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody-awake.html) 
...
In this case, rotating fast may be desirable so you can enable this feature using [PhysicsBody.fastRotationAllowed](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsBody-fastRotationAllowed.html).
