...
The [PhysicsTransform](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsTransform.html) bundles these into a single structure with `position` and `rotation` properties.
The `position` is defined with a [Vector2](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Vector2.html) whereas the `rotation` is defined with a dedicated physics type of [PhysicsRotate](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsRotate.html), 
...
- **Multiply Transform**: You can [multiply](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsTransform.MultiplyTransform.html) and [inverse-multiply](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsTransform.InverseMultiplyTransform.html) `PhysicsTransform` together.
- **Transform Point**: You can [transform](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsTransform.TransformPoint.html) and [inverse-transform](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsTransform.InverseTransformPoint.html) `Vector2`.
