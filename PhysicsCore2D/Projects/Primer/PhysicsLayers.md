...
Unity’s built-in [Layer](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/LayerMask.html) system uses a 32-bit integer (`int`) where each bit represents one layer (up to 32 total), making it efficient for tasks like collision filtering.
...
To enable this, the [`PhysicsLayers`](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsLayers.html) type lets you use 64-bit layers or operate in a backward-compatible mode that uses the existing 32-layer system.
...
- [PhysicsShape.ContactFilter](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsShape.ContactFilter.html): Controls which `PhysicsShape` pair can create contacts.
- [PhysicsQuery.QueryFilter](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsQuery.QueryFilter.html): Controls which `PhysicsShape` are returned from queries.
...
- [GetLayerMask](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsLayers.GetLayerMask.html): Get a mask from one or more layer names.
- [GetLayerName](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsLayers.GetLayerName.html): Get a layer name from an ordinal (number).
- [GetLayerOrdinal](https://docs.unity3d.com/6000.5/Documentation/ScriptReference/Unity.U2D.Physics.PhysicsLayers.GetLayerOrdinal.html): Get an ordinal (number) from a layer name.
...
To configure whether the physics layer system is used and to set its layer names, assign and configure the low-level settings asset (see [PhysicsCoreSettings2D](PhysicsCoreSettings2D.md) for details).
